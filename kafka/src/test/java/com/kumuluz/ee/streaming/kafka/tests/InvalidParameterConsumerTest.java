...
import com.kumuluz.ee.streaming.kafka.tests.beans.InvalidParameterConsumer;
 ...
 */
@Test
public class InvalidParameterConsumerTest extends Arquillian {

    @Deployment
    @ShouldThrowException(value = DeploymentException.class, testable = true)
    public static JavaArchive createDeployment() {
        return ShrinkWrap.create(JavaArchive.class)
                .addClass(InvalidParameterConsumer.class)
