...
public class DependencyAppender implements MavenDependencyAppender {
    ...
    private static final ResourceBundle versionsBundle = ResourceBundle
            .getBundle("META-INF/kumuluzee/streaming/versions");
    ...
    public List<String> addLibraries() {
        ...
        libs.add("org.apache.kafka:kafka-clients:" + versionsBundle.getString("kafka-clients-version"));
        libs.add("org.apache.kafka:kafka-streams:" + versionsBundle.getString("kafka-streams-version"));
