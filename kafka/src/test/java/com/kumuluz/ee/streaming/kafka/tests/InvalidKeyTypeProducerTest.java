...
import com.kumuluz.ee.streaming.kafka.tests.beans.InvalidKeyTypeProducer;
 ...
 */
@Test
public class InvalidKeyTypeProducerTest extends Arquillian {

    @Deployment
    @ShouldThrowException(value = DefinitionException.class, testable = true)
    public static JavaArchive createDeployment() {
        return ShrinkWrap.create(JavaArchive.class)
                .addClass(InvalidKeyTypeProducer.class)
