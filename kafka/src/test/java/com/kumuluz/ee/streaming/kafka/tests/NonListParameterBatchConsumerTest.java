...
import com.kumuluz.ee.streaming.kafka.tests.beans.NonListParameterBatchConsumer;
 ...
 */
@Test
public class NonListParameterBatchConsumerTest extends Arquillian {

    @Deployment
    @ShouldThrowException(value = DeploymentException.class, testable = true)
    public static JavaArchive createDeployment() {
        return ShrinkWrap.create(JavaArchive.class)
                .addClass(NonListParameterBatchConsumer.class)
