...
import com.kumuluz.ee.streaming.kafka.tests.beans.InvalidKeyTypeBatchConsumer;
 ...
 */
@Test
public class InvalidKeyTypeBatchConsumerTest extends Arquillian {

    @Deployment
    @ShouldThrowException(value = DeploymentException.class, testable = true)
    public static JavaArchive createDeployment() {
        return ShrinkWrap.create(JavaArchive.class)
                .addClass(InvalidKeyTypeBatchConsumer.class)
