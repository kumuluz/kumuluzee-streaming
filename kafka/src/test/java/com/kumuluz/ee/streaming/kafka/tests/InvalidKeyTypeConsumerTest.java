...
import com.kumuluz.ee.streaming.kafka.tests.beans.InvalidKeyTypeConsumer;
 ...
 */
@Test
public class InvalidKeyTypeConsumerTest extends Arquillian {

    @Deployment
    @ShouldThrowException(value = DeploymentException.class, testable = true)
    public static JavaArchive createDeployment() {
        return ShrinkWrap.create(JavaArchive.class)
                .addClass(InvalidKeyTypeConsumer.class)
