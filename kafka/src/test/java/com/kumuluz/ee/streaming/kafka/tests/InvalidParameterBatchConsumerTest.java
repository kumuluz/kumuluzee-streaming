...
import com.kumuluz.ee.streaming.kafka.tests.beans.InvalidParameterBatchConsumer;
 ...
 */
@Test
public class InvalidParameterBatchConsumerTest extends Arquillian {

    @Deployment
    @ShouldThrowException(value = DeploymentException.class, testable = true)
    public static JavaArchive createDeployment() {
        return ShrinkWrap.create(JavaArchive.class)
                .addClass(InvalidParameterBatchConsumer.class)
